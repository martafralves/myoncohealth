<div class="container">
        <div class="row">
            <div class= "col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 mt-5 pt-3 pb-3 mb-5">
                ...
                <hr>
                <form action="<?=base_url('update/'.$appointment['bid'])?>" method="post">
                <?php if (isset($validation)):?>
                    ...
                    <div class = "row">
                        ...
                        <div class = "col-12 col-sm-6">
                            <div class = "form-group">
                                ...
                                <select id="time" name="time" value="<?= $appointment['time']?>" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="observations" id = "observations" value="<?= $appointment['observations']?>" placeholder="Enter any observations"></textarea>
                    </div>
                    <div class ="row">
